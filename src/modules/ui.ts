...
import { PlayerPerformanceData } from './scoring.js';
...
function saveResult() {
    const player: PlayerPerformanceData = {
...
function displayScore( categoryScores: any, totalScore: number, totalPoints: number, maxPoints: number): void {
...
resultDiv.appendChild(restartBtn);
    ...
    leaderboard.forEach((p: any, index: number) => {
