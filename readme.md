...
Notiz: Module für Aufgabe:
    • UI Module
        ◦ 
    • DataManager (daten holen und speichern)
          Funktionen:
        ◦ getQuestions(catagories
                                  : Catagory[list] oder  : string[]
                                  count: number
                                  options: QuestionOpts)
        ◦ getLeaderBoard(): leaderBoard
        ◦ saveLeaderBoard(b: leaderBoard)
    • ScoringModule (statitik ausrechnen)
          Funktionen:
