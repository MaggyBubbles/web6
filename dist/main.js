import { distributeQuestions, fetchQuestions, shuffleArray } from "./modules/questions.js";
import { calculatePercentage, calculateScore, fetchLeaderboard, myLeaderBoard, savePerformanceData } from "./modules/scoring.js";
...
let currentQuestions = distributeQuestions(data);
...
currentQuestions.forEach(element => {
    ...
    } //quiz eventuell NULL daher mit if-Abfrage überprüfen
});
let test = [
...
let test2 = [{ answer: "3", correctAnswer: "3", category: "math", difficulty: "easy" },
    { answer: "Mona Lisa", correctAnswer: "Mona Lisa", category: "cultue", difficulty: "medium" },
    { answer: "4", correctAnswer: "4", category: "math", difficulty: "easy" },
    { answer: "5", correctAnswer: "5", category: "math", difficulty: "medium" },
    { answer: "3", correctAnswer: "3", category: "math", difficulty: "hard" },
];
let test3 = [{ answer: "3", correctAnswer: "3", category: "math", difficulty: "easy" },
    { answer: "Mona Lisa", correctAnswer: "Mona Lisa", category: "cultue", difficulty: "medium" },
    { answer: "4", correctAnswer: "4", category: "math", difficulty: "easy" },
    { answer: "5", correctAnswer: "5", category: "math", difficulty: "medium" },
...
let player1 = { playerName: "Violett", playerScore: testresult, playerPercentage: testpercent };
savePerformanceData(player1);
let player2 = { playerName: "Augusta", playerScore: testresult2, playerPercentage: testpercent2 };
savePerformanceData(player2);
let player3 = { playerName: "Augusta", playerScore: testresult3, playerPercentage: testpercent3 };
